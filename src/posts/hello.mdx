...
keywords: [Hello world, open-source]
showToc: true
---
...
<Callout tag="info" title="Explaining how to use callouts">
...
<Callout tag="success" title="Good to know">
  Please note that the documentation is currently under construction and some sections may be incomplete or subject to
  changes. We are working hard to provide you with comprehensive and accurate information.
</Callout>

<Callout tag="warning" title="Something isn't working">
  Please note that the documentation is currently under construction and some sections may be incomplete or subject to
  changes. We are working hard to provide you with comprehensive and accurate information.
</Callout>

<Callout tag="error" title="This will break shit">
  Please note that the documentation is currently under construction and some sections may be incomplete or subject to
  changes. We are working hard to provide you with comprehensive and accurate information.
</Callout>
...
<Callout tag="info" emoji="😍">
  Please note that the documentation is currently under construction and some sections may be incomplete or subject to
  changes. We are working hard to provide you with comprehensive and accurate information.
</Callout>

<Callout tag="success" emoji="🚀" title="Lift off">
  Please note that the documentation is currently under construction and some sections may be incomplete or subject to
  changes. We are working hard to provide you with comprehensive and accurate information.
</Callout>
